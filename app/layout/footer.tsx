  ...
  return (
    <footer className="relative z-10 border-t border-amour-border px-4 py-10 sm:px-6">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.4fr_1fr_1fr]">
        <div><div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-full bg-amour-crimson text-amour-gold"><Feather className="h-4 w-4" /></span><h2 className="font-heading text-3xl tracking-widest">AMOUR</h2></div><p className="mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">Anonymous love chronicles, missed connections, and midnight letters kept in a velvet archive.</p></div>
